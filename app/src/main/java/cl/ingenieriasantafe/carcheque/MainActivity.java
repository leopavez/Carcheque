...
public class MainActivity extends AppCompatActivity {
    ...
    Button login;
    public static final String APIUsuarios = "";
    public static final String APIVEHICULOS = "";
    public static final String APICHOFERES = "";
    public static final String APICAMINOS = "";
    public static final String APIPLANTAS = "";
